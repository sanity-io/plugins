...
- [#1989](https://github.com/sanity-io/plugins/pull/1989) [`a934807`](https://github.com/sanity-io/plugins/commit/a934807e4bca1b808dc301ff1540a940ee1bfad6) Thanks [@squiggler-app](https://github.com/apps/squiggler-app)! - fix(deps): update dependency oxlint to ^1.83.0

## 10.0.9

### Patch Changes

- [#1920](https://github.com/sanity-io/plugins/pull/1920) [`2741154`](https://github.com/sanity-io/plugins/commit/274115495da183550996ef226ae4775d5d7e01e1) Thanks [@squiggler-app](https://github.com/apps/squiggler-app)! - fix(deps): update dependency oxlint to ^1.80.0
...
- [#1353](https://github.com/sanity-io/plugins/pull/1353) [`5ff7063`](https://github.com/sanity-io/plugins/commit/5ff70639f75bce2a4d7ef88aa2ec03d82cae4acc) Thanks [@stipsan](https://github.com/stipsan)! - Remove `@sanity/incompatible-plugin` from scaffolding and detect leftover usage
...
- [#1351](https://github.com/sanity-io/plugins/pull/1351) [`7078a73`](https://github.com/sanity-io/plugins/commit/7078a73c81832e3fc5947c072fe00c8fc397795f) Thanks [@stipsan](https://github.com/stipsan)! - Remove the deprecated `ui-workshop` preset. `@sanity/ui-workshop` is no longer maintained, so `init`/`inject` no longer accept `--preset ui-workshop`.

### Minor Changes

- [#1354](https://github.com/sanity-io/plugins/pull/1354) [`3217cf8`](https://github.com/sanity-io/plugins/commit/3217cf801b2e84f41336d6ffa097dd77289a0383) Thanks [@stipsan](https://github.com/stipsan)! - Add a `verify-package` check that bans CommonJS interop in `package.json`
...
- [#1352](https://github.com/sanity-io/plugins/pull/1352) [`2bae6e5`](https://github.com/sanity-io/plugins/commit/2bae6e5c958d7b90449a13a9ef57ea45f831a454) Thanks [@stipsan](https://github.com/stipsan)! - Add a `verify-package` check that bans `src` from the package.json `files` array, and stop including `src` in the `files` array generated by `init`. Disable it with `sanityPlugin.verifyPackage.bannedFiles: false`.

### Patch Changes

- [#1340](https://github.com/sanity-io/plugins/pull/1340) [`b3c4cc6`](https://github.com/sanity-io/plugins/commit/b3c4cc619bc685fe857c8dfe2a927e690ff2b38a) Thanks [@squiggler-app](https://github.com/apps/squiggler-app)! - fix(deps): Update dependency get-it to v9

- [#1341](https://github.com/sanity-io/plugins/pull/1341) [`34c2c6f`](https://github.com/sanity-io/plugins/commit/34c2c6fe9ab79534025ddf4e2b40f40ca053e842) Thanks [@squiggler-app](https://github.com/apps/squiggler-app)! - fix(deps): Update dependency get-latest-version to v6

- [#1354](https://github.com/sanity-io/plugins/pull/1354) [`3217cf8`](https://github.com/sanity-io/plugins/commit/3217cf801b2e84f41336d6ffa097dd77289a0383) Thanks [@stipsan](https://github.com/stipsan)! - Scaffold the `sanity` peer dependency as `^5 || ^6.0.0-0`
...
- [#1359](https://github.com/sanity-io/plugins/pull/1359) [`c68af26`](https://github.com/sanity-io/plugins/commit/c68af26ead79dc2f973dd9ec41ae897daa4f2363) Thanks [@stipsan](https://github.com/stipsan)! - Replace `@ts-expect-error` suppressions with proper type definitions for package validation and license selection dependencies
...
- [#1202](https://github.com/sanity-io/plugins/pull/1202) [`d95117b`](https://github.com/sanity-io/plugins/commit/d95117b7a728febf6580924189b438af006c1c04) Thanks [@squiggler-app](https://github.com/apps/squiggler-app)! - fix(deps): Update dependency get-it to ^8.8.0

## 5.0.0

### Major Changes

- [#979](https://github.com/sanity-io/plugins/pull/979) [`cbc58a8`](https://github.com/sanity-io/plugins/commit/cbc58a89c17fb67c62d39356c7572202bed6100a) Thanks [@rexxars](https://github.com/rexxars), [@snorrees](https://github.com/snorrees), [@stipsan](https://github.com/stipsan), [@mariuslundgard](https://github.com/mariuslundgard), [@hdoro](https://github.com/hdoro), [@nkgentile](https://github.com/nkgentile), [@runeb](https://github.com/runeb), [@dorelljames](https://github.com/dorelljames), [@geball](https://github.com/geball), [@rcmaples](https://github.com/rcmaples)! - Port @sanity/plugin-kit to the Sanity plugins monorepo
