...
const TreeNodeRendererScaffold = (props: any) => {
  const {
    lowerSiblingCounts,
  ...
  const scaffold: ReactNode[] = lowerSiblingCounts.map((lowerSiblingCount: number, i: number) => {
    ...
    return (
      <div
        // oxlint-disable-next-line react/no-array-index-key - scaffold blocks are purely positional
        key={i}
        style={style}
