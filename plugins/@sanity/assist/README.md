# TODO: Manual Steps for `@sanity/assist`

This plugin was scaffolded using `pnpm generate "copy plugin"`.

**Original repository:** https://github.com/sanity-io/assist
...
**https://www.npmjs.com/package/@sanity/assist/access**
...
`dev/test-studio/src/assist/index.tsx`
