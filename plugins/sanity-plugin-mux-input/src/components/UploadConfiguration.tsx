...
export default function UploadConfiguration({
  ...
  // oxlint-disable-next-line react/react-compiler -- `.current` is read once to seed immutable default subtitle tracks
  ...
  const [config, dispatch] = useReducer(
    // oxlint-disable-next-line react/react-compiler -- reducer closes over `autoTextTracks` ref seed
  ...
  useEffect(() => {
    ...
    if (valid) {
      // oxlint-disable-next-line react/react-compiler -- sync validationError from derived validity checks
