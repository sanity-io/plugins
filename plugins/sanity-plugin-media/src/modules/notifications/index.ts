// oxlint-disable typescript/no-deprecated, typescript/no-unnecessary-type-conversion, typescript/no-unsafe-type-assertion - legacy code will be lint-cleaned in a follow-up PR
