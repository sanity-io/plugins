// oxlint-disable jsx_a11y/control-has-associated-label, react/no-unstable-nested-components, react/react-compiler, typescript/no-deprecated, typescript/no-unsafe-type-assertion - legacy code will be lint-cleaned in a follow-up PR
