...
const FolderHeaderAction = ({disabled, icon, onClick, tone, tooltip}: FolderHeaderActionProps) => (
  <Tooltip
    animate
    content={
...
const FolderNode = ({currentFolderId, expandedIds, node, onSelect, onToggle}: FolderNodeProps) => {
