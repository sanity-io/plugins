// oxlint-disable jsx-a11y/control-has-associated-label, react/no-unstable-nested-components, typescript/no-unsafe-type-assertion - legacy media plugin ported code
