# TODO: Manual Steps for `sanity-plugin-media`

This plugin was scaffolded using `pnpm generate "copy plugin"`.

**Original source:** https://github.com/sanity-io/sanity-plugin-media
...
```bash
npm trust github sanity-plugin-media --file=release.yml --repository=sanity-io/plugins
```
...
1. Go to **https://www.npmjs.com/package/sanity-plugin-media/access**
...
`dev/test-studio/src/media/index.tsx`
