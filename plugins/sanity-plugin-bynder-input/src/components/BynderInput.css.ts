 ...
 * `BynderInput` only mounts the modal while it is open, so the host (and this overlay) is
 * removed from the DOM on close and never blocks interaction with the Studio.
 */
