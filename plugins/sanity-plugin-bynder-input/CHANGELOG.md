...
- [#1958](https://github.com/sanity-io/plugins/pull/1958) [`af03610`](https://github.com/sanity-io/plugins/commit/af03610a887d1c9a080ca60fec76041994cf8979) Thanks [@stipsan](https://github.com/stipsan)! - Upgrade `@bynder/compact-view` to 6, which declares React 19 in its peer dependencies. Installing the plugin no longer needs the stale-peer-range workaround (`--legacy-peer-deps` on npm, `peerDependencyRules.allowedVersions` on pnpm).
