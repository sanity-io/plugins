# TODO: Manual Steps for `sanity-plugin-iframe-pane`

This plugin was scaffolded using `pnpm generate "copy plugin"`.

**Original source:** https://github.com/sanity-io/sanity-plugin-iframe-pane
...
**https://www.npmjs.com/package/sanity-plugin-iframe-pane/access**
...
cd plugins/sanity-plugin-iframe-pane

# Clone the original repo and copy the src directory
git clone https://github.com/sanity-io/sanity-plugin-iframe-pane /tmp/original-plugin
...
`dev/test-studio/src/iframe-pane/index.tsx`
