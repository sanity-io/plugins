# TODO: Manual Steps for `sanity-plugin-shopify-assets`

This plugin was scaffolded using `pnpm generate "copy plugin"`.

**Original source:** https://github.com/sanity-io/sanity-plugin-shopify-assets
...
```bash
npm trust github sanity-plugin-shopify-assets --file=release.yml --repository=sanity-io/plugins
```
...
1. Go to **https://www.npmjs.com/package/sanity-plugin-shopify-assets/access**
...
`dev/test-studio/src/shopify-assets/index.tsx`
