# TODO: Manual Steps for `sanity-plugin-asset-source-unsplash`

This plugin was scaffolded using `pnpm generate "copy plugin"`.

**Original source:** https://github.com/sanity-io/sanity-plugin-asset-source-unsplash
...
**https://www.npmjs.com/package/sanity-plugin-asset-source-unsplash/access**
...
git clone https://github.com/sanity-io/sanity-plugin-asset-source-unsplash /tmp/original-plugin
...
1. Delete this README.md and replace it with the original plugin's README
2. Run `pnpm install` from the monorepo root
3. Run `pnpm build` to verify the plugin builds correctly
4. Run `pnpm dev` to test in the test studio
5. Create a changeset: `pnpm changeset add`
